    ...
    <>
      <div className={styles.teste}>
        ...
        <div className={styles.banner}>
          <img src={teste} alt="Dedo do meio" />
          <div>
            <Titulo titulo="Orçamento fácil" />
            <p>
              Em poucos minutos você faz seu orçamento. É rápido, prático,
        ...
        <Container className={styles.historia}>
